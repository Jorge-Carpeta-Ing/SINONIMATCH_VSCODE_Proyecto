...
// {
// put(1, Arrays.asList(
// new Pregunta("Feliz", new String[] { "Triste", "Enojado", "Contento", "Serio"
// }, 2),
// new Pregunta("Rápido", new String[] { "Lento", "Ligero", "Tonto", "Duro" },
// 1),
// new Pregunta("Grande", new String[] { "Pequeño", "Amplio", "Claro",
// "Estrecho" }, 1),
// new Pregunta("Valiente", new String[] { "Cobarde", "Temeroso", "Audaz",
// "Débil" }, 2),
// new Pregunta("Fácil", new String[] { "Complicado", "Simple", "Confuso",
// "Inútil" }, 1),
// new Pregunta("Cansado", new String[] { "Dormido", "Fatigado", "Activo",
// "Despierto" }, 1),
// new Pregunta("Contento", new String[] { "Molesto", "Alegre", "Triste",
// "Rabioso" }, 1),
// new Pregunta("Tranquilo", new String[] { "Calmado", "Nervioso", "Agitado",
// "Irritado" }, 0)));
// put(2, Arrays.asList(
// new Pregunta("Sabio", new String[] { "Ignorante", "Erudito", "Tonto",
// "Absurdo" }, 1),
// new Pregunta("Agradable", new String[] { "Desagradable", "Encantador",
// "Áspero", "Cruel" }, 1),
// new Pregunta("Elegante", new String[] { "Rústico", "Hermoso", "Distinguido",
// "Tosco" }, 2),
// new Pregunta("Sincero", new String[] { "Mentiroso", "Honesto", "Tramposo",
// "Hipócrita" }, 1),
// new Pregunta("Hermético", new String[] { "Cerrado", "Abierto", "Claro",
// "Directo" }, 0),
// new Pregunta("Amable", new String[] { "Rudo", "Cortés", "Arrogante",
// "Molesto" }, 1),
// new Pregunta("Generoso", new String[] { "Egoísta", "Dadivoso", "Tacaño",
// "Avaro" }, 1),
// new Pregunta("Firme", new String[] { "Débil", "Constante", "Blando", "Tierno"
// }, 1)));
// put(3, Arrays.asList(
// new Pregunta("Inquebrantable", new String[] { "Rígido", "Firme", "Flexible",
// "Débil" }, 1),
// new Pregunta("Perspicaz", new String[] { "Ingenuo", "Astuto", "Torpe",
// "Ciego" }, 1),
// new Pregunta("Exánime", new String[] { "Muerto", "Vivo", "Energético",
// "Animado" }, 0),
// new Pregunta("Efímero", new String[] { "Eterno", "Corto", "Fugaz", "Duradero"
// }, 2),
// new Pregunta("Melancolía", new String[] { "Tristeza", "Felicidad", "Rabia",
// "Dicha" }, 0),
// new Pregunta("Tenaz", new String[] { "Perseverante", "Perezoso", "Flojo",
// "Débil" }, 0),
// new Pregunta("Sagaz", new String[] { "Tonto", "Lento", "Agudo", "Torpe" },
// 2),
// new Pregunta("Abrupto", new String[] { "Suave", "Repentino", "Leve",
// "Constante" }, 1)));
// }
// };
...
// new Image(new File("assets/background.jpg").toURI().toString(), 600, 500,
// false, true),
...
// ImageView avatar = new ImageView(new Image(new
// File("assets/avatar.jpg").toURI().toString()));
...
// sonidoCorrecto = new AudioClip(new
// File("assets/correcto.mp3").toURI().toString());
// sonidoIncorrecto = new AudioClip(new
// File("assets/incorrecto.mp3").toURI().toString());
// sonidoVictoria = new AudioClip(new
// File("assets/victoria.mp3").toURI().toString());
// }

// private void iniciarNivel() {
// preguntasNivel = new ArrayList<>(bancoPreguntas.get(nivel));
// Collections.shuffle(preguntasNivel);
// preguntasNivel = preguntasNivel.subList(0, Math.min(5,
// preguntasNivel.size()));
// preguntaActual = 0;
...
// Label victoria = new Label("🎉 ¡Ganaste! Obtuviste " + puntaje + " puntos.
// ¡Felicidades!");
